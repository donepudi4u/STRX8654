...
var loginUser = ''; // use this to test for approver viewing the STR
  ...
  //$("#STRtableDisp").find("input,button,textarea,select").prop("disabled", false);
    for(i=1; i<counter; i++){
        ...
        var  row = $('<tr  class="SCMtr" style="display:table-row;"><TD  style="width:100px">' +
                '<input style="display:table-cell; width:100%;" type="text" class="DeviceL" id="DeviceL' + i + '" name="DeviceL' + i + '"  value =' + LotsForSTR[ i - 1][ 0] + '></TD>' +
                '<TD  style="width:100px" ><input style="display:table-cell; width:100%;" type="text" class="ProcessL"  id="ProcessL' + i + '" name="ProcessL' + i + '"  value =' + LotsForSTR[ i - 1][ 1] + '></TD>' +
                '<TD style="width:100px"><input style="display:table-cell; width:100%;" type="text" class="Lot_" id="Lot_' + i + '" name="Lot_' + i + '"  value =' + LotsForSTR[ i - 1][ 2] + '></TD>' +
                ...
                '<TD style="width:130px"><input style="display:table-cell; width:100%;" type="text" class ="SCMApp" id="SCM_' + i + '" name="SCM_' + i + '"  value =""></TD>'
      ...
      var  row2 = $('<tr class="Disptr" style="display:table-row;"><TD style="width:100px"><input  style="display:table-cell; width:100%;" type="text" class = "QADispL" id="QADispL' + i + '" name="QADispL' + i + '"  value ="' + LotsForSTR[ i - 1 ][ 3 ] + '"></TD ><TD  style="width:100px">' +
              '<input   type="checkbox" class="Prob" id="Prob' + i + '" name="Prob' + i + '">Yes<input class="ProbI"  id="ProbI' + i + '" name="ProbI' + i + '"  type="hidden" value=' + LotsForSTR[ i - 1][ 9] + ' ></TD><TD  style="width:100px">' + ' <select  id= "DispositionL' + i + '" name="DispositionL' + i + '">' +       
                               shipselect +
                        '</select></TD><TD style="width:100px"><input  style="display:table-cell; width:100%;" type="text" id="PLD_' + i + '" name="PLD_' + i + '"  value ="' + LotsForSTR[ i - 1][ 4] + '"></TD><TD  style="width:200px"><input  style="width:100%;" type="text" id="PEMgrOKSHip' + i + '" name="PEMgrOKSHip' + i + '"  value ="' + LotsForSTR[ i - 1][ 5] + '"></TD><TD  style="width:100px">' + 
...
<!--                        <input disabled style="display:table-cell; width:100%;" type="text" id="Area" name="Area"  value ="${replys.get("Area")}" ></TD>-->
                    ...
                    <TD style="width:200px" ><input style="display:table-cell; width:100%;" name="Final_Report_Date" id="Final_Report_Date" type="text" value="${replys.get("Final_Report_Date")}" ></TD>
                    </TR>
                     <TR>
...
<!--              <i class="table-info">  </i> <i class="table-updated"> (Last Refresh: <span id="history_updated">Never</span>)</i>-->
             <TABLE class= "STRtable" id="STRtable3" BORDER="2" CELLPADDING="2" CELLSPACING="2" >
                    ...
                    <TD style="width:470px" ><input  id="Total_Lots" name="Total_Lots" style="display:table-cell; width:100%;" type='text' value= "${replys.get("Total_Lots")}" ></TD>
...
<p><b>STR Instructions: </b><div class="strinstructions" id="STR_INSTRUCTION" name="STR_INSTRUCTION" contenteditable="true" style="width: 870px;height: 300px;overflow: auto;border: 1px solid black">${replys.get("STR_INSTRUCTION")}</div></p>
          ...
          <p id="poststrattachment"><b>Post Completion Comments:</b></p>
           ...
           <br>
            ...
            <TD  style="width:400px" ><input id="RelTestMgr" name="RelTestMgr"  style="display:table-cell; width:100%;" type='text' value='${replys.get("RelTestRelMgr")}' ></TD>
            ...
            <TD  colspan="5" style="width:730px" ><input id="RelTestsList" name="RelTestsList" style="display:table-cell; width:100%;" type='text' value='${replys.get("RelTestsList")}' ></TD>
             </TR>
              <TR>
            <TD style="width:100px"  bgcolor="lightgray">Rel Manager Comment About Reliability Tests:</TD>
            <TD  colspan="5" style="width:730px" ><input disabled id="Rel1Comment" name="Rel1Comment"  style="display:table-cell; width:100%;" type='text' value='${replys.get("Rel1Comment")}' ></TD>
             </TR>
            </table>
            ...
            <TD style="width:400px" ><input  id="CustDelQAMgr"  name="CustDelQAMgr"  style="display:table-cell; width:100%;" type='text' value='${replys.get("CustDelQAMgr")}' ></TD>
            <TD style="width:50px" bgcolor="lightgray">Date:</TD>
            ...
            <TD style="width:50px" bgcolor="lightgray">QA:</TD>
            <TD  style="width:400px" ><input id="RelProdQAMgr"  name="RelProdQAMgr"  style="display:table-cell; width:100%;" type='text' value='${replys.get("RelProdQAMgr")}' ></TD>
            <TD style="width:50px" bgcolor="lightgray">Date:</TD>
...
//            //Have all forms copy editable content to the adjacent input before submitting
   ...
   <form class= "LotGroup1" id="formAddLots" action="#" title="Add Lots"  width="auto" >
                  ...
                  <TR>
                     ...
                     <TD style="width:150px" colspan="2"><input name="SearchPart" id="SearchPart"    type='text' style="display:table-cell; width:100%;"   value="${replys.get("SearchPart")}"  ></TD>
                    <TD style="width:100px" bgcolor="lightgray"> OR Process:</TD>
                    <TD style="width:150px" colspan="2"><input  name="SearchProcess" id="SearchProcess" style="display:table-cell; width:100%;" type='text' value="${replys.get("SearchProcess")}" ></TD>
                    </tr>
                     <tr>
                    <TD style="width:100px" bgcolor="lightgray">Wafers # > :</TD>
                    <TD style="width:100px" ><input name="Wafers" id="Wafers" type="number" style="display:table-cell; width:100%;"  value="${replys.get("Wafers")}"></TD>
                    ...
                    <TD style="width:100px" ><input name="LotType" id="LotType" type="text" style="display:table-cell; width:100%;"  value="${replys.get("LotType")}"></TD>
                     </tr>
                    <tr>
                    <TD style="width:100px" bgcolor="lightgray">Lots Not Past Stage:</TD>
                    <TD style="width:150px" colspan="2" ><input name="LotsStage" id="LotsStage" type="text" style="display:table-cell; width:100%;"  value="${replys.get("LotsStage")}"></TD>
...
//                             });
      ...
      $("#SearchT").click(function(evt){
                ...
                if (obj.length!==0) {
                    //console.log("submitting TYPES ajax request= " + JSON.stringify(obj) );
                   $.ajax({ url:"/STRform_woutMaven/SearchPromisEQ",
                    method: "POST",
                    data: JSON.stringify(obj) 
                }).done(function(msg) {
                   var json = JSON.parse(msg);
        ...
        //the Search button is on the Lots for STR dialog window and returns lots from Promis
         $("#Search").click(function(evt){
                ...
                if (obj.length!==0) {
                    //console.log("submitting TYPES ajax request= " + JSON.stringify(obj) );
                   $.ajax({ url:"/STRform_woutMaven/SearchPromisTlog",
                    method: "POST",
                    data: JSON.stringify(obj) 
                }).done(function(msg) {
                    setTable(msg);
              ...
              //call servlet to create a new STR and fill in STRtable1 and STRtable2 from the current table
                       ...
                       var Group7Val = $("#Group7").val();
                        ...
                        add:[]
                            ...
                            if (obj.length!==0) {
                                //console.log("submitting TYPES ajax request= " + JSON.stringify(obj) );
                               $.ajax({ url:"/STRform_woutMaven/DuplicateSTR",
                                method: "POST",
                                data: JSON.stringify(obj) 
                            }).done(function(msg) {
                                var json = JSON.parse(msg);
...
//                    }
             ...
             width: 800,
                             ...
                             for(var kk =  counter1; kk <= counter ; kk ++) {
                               // var  row1 = $('<tr style="display:none;"><TD  style="width:100px"><input style="display:table-cell; width:100%;" type="text" id="DeviceL' + kk + '" name="DeviceL' + kk + '" readonly value =' + "" + '></TD><TD  style="width:100px" ><input style="display:table-cell; width:100%;" type="text" id="ProcessL' + kk + '" name="ProcessL' + kk + '" readonly value =' + "" + '></TD><TD style="width:100px"><input style="display:table-cell; width:100%;" type="text" id="Lot_' + kk + '" name="Lot_' + kk + '" readonly value =' + "" + '></TD><TD style="width:100px"><button id="AppRej' + i + '" name="AppRej' + i + '" type="button" >AppRej</button></TD><TD style="width:130px"><input style="display:table-cell; width:100%;" type="text" id="SCM_' + kk + '" name="SCM_' + kk + '" readonly value =""></TD><TD style="width:100px"><input type="checkbox" id="LotCony' + kk + '" name="LotCony' + kk + '" >Yes</TD></tr>');
                                //var  row111 = $('<tr  class="SCMtr" style="display:none;"><TD  style="width:100px"><input style="display:table-cell; width:100%;" type="text" id="DeviceL' + kk + '" name="DeviceL'+  kk + '"  value =' + "" + '></TD><TD  style="width:100px" ><input style="display:table-cell; width:100%;" type="text" id="ProcessL' +kk + '" name="ProcessL' + kk + '"  value =' + "" + '></TD><TD style="width:100px"><input style="display:table-cell; width:100%;" type="text" id="Lot_' + kk + '" name="Lot_' +kk + '"  value =' + "" + '></TD><TD style="width:100px"><input type="checkbox" class ="AppRej" id="AppRej' + kk + '" name="AppRej' + kk + '" >Approve or Reject</TD><TD style="width:130px"><input style="display:table-cell; width:100%;" type="text" class ="SCMApp" id="SCM_' + kk + '" name="SCM_' + kk + '"  value =""></TD><TD style="width:100px"><input type="checkbox" id="LotCony' + kk + '" name="LotCony' + kk + '" class ="LotCony" >Yes</TD></tr>');
                                 var  row111 = $('<tr  class="SCMtr" style="display:table-row;"><TD  style="width:100px">' +
                '<input style="display:table-cell; width:100%;" type="text" id="DeviceL' + kk + '" name="DeviceL' + kk + '"  value =' + "" + '></TD>' +
                '<TD  style="width:100px" ><input style="display:table-cell; width:100%;" type="text" id="ProcessL' +kk + '" name="ProcessL' + kk + '"  value =' + "" + '></TD>' +
                '<TD style="width:100px"><input style="display:table-cell; width:100%;" type="text" id="Lot_' + kk + '" name="Lot_' + kk + '"  value =' + "" + '></TD>' +
                ...
                '<TD style="width:130px"><input style="display:table-cell; width:100%;" type="text" class ="SCMApp" id="SCM_' + kk + '" name="SCM_' + kk + '"  value =""></TD>'
                + '<TD style="width:100px"><input type="checkbox" class ="LotCony" id="LotCony' + kk + '" name="LotCony' + kk + '" >Yes<input class="LotCony" id="LotConyI' + kk + '" name="LotConyI' + kk + '" type="hidden" value= "' + "" + '" ></TD></tr>');
                                ...
                                var row222 = $('<tr class="Disptr" style="display:table-row;"><TD style="width:100px"><input  style="display:table-cell; width:100%;" type="text" id="QADispL' + kk + '" name="QADispL' + kk + '"  value ="' + "" + '"></TD ><TD  style="width:100px">' +
                               ...
                               shipselect +
                                '</select></TD><TD style="width:100px"><input  style="display:table-cell; width:100%;" type="text" id="PLD_' + kk + '" name="PLD_' + kk + '"  value =""></TD><TD  style="width:200px"><input  style="width:100%;" type="text" id="PEMgrOKSHip' + kk + '" name="PEMgrOKSHip' + kk + '"  value =""></TD><TD  style="width:100px">' + 
                      ...
                      'Save' : function () {
                            ...
                            obj.add[obj.add.length] = {
                               ...
                               // status:statusVal
                                    ...
                                    if (obj.length!==0) {
                                           $.ajax({ url:"/STRform_woutMaven/GetAppGroups",
                                            method: "POST",
                                            data: JSON.stringify(obj) 
                                        }).done(function(msg) {
                                        var json = JSON.parse(msg);
